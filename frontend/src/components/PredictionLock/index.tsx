...
const PredictionLock = ({ isLocked }: IPredictionLock) => {
  ...
  return (
    <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 transform items-center justify-center gap-4 rounded-md bg-white px-4 py-2">
